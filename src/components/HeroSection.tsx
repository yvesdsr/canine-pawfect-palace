...
const HeroSection = () => {
  ...
  return (
    <section id="accueil" className="relative bg-gradient-to-br from-blue-600 via-indigo-600 to--700 text-white py-20 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-2 text-yellow-300">
                ...
                <Star className="w-5 h-5 fill-current" />
                <Star className="w-5 h-5 fill-current" />
                <span className="ml-2 text-sm">Plus de 50 familles heureuses</span>
              </div>
